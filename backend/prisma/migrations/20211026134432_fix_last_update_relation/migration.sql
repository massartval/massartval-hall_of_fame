...
INSERT INTO "new_Link" ("createdAt", "description", "id", "lastUpdatedAt", "lastUpdatedById", "postedById", "url") SELECT "createdAt", "description", "id", "lastUpdatedAt", "lastUpdatedById", "postedById", "url" FROM "Link";
DROP TABLE "Link";
